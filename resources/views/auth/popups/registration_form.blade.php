            <form method="POST" action="{{ route('register') }}" id="captcha-validate-4" class="js-form js-reg-form" style="display: {{ $reg_style_par }};">
                ...
                <div class="personal-data-checkbox">
                    ...
                    <div class="personal-data-links-string">
                        Ознакомлен с
                        <a href="{{ asset('page/obrabotka-personalnyh-dannyh') }}" target="_blank">Политикой конфиденциальности</a>
                        и
                        <a href="{{ asset('page/dogovor-publichnoy-oferty') }}" target="_blank">Договором публичной оферты</a>.
                ...
                <button class="submit-button js-reg-form-submit" type="submit">
                    Регистрация
                </button>
