...
<div class="invoice-page">
	<div class="container">
		...
		<div class="invoice_block">
			...
			<h1>Онлайн оплата заказа №{{ $order->id }}</h1>
			...
			<div class="invoice_content">
				...
				<div class="menager-consult text">
					<p>
						Перед проведением платежа картой онлайн, необходимо проконсультироваться с менеджером интернет-магазина по наличию товара!
					</p>
					<p>
						Контакты:
...
@endphp
				<form method="post" action="https://payment.webpay.by">
					...
					<input type="hidden" name="wsb_return_url" value="https://7150.by/online-payment-success">
					<input type="hidden" name="wsb_cancel_return_url" value="https://7150.by/online-payment-cancel">
					{{-- <input type="hidden" name="wsb_notify_url" value="https://7150.by/online-payment-notify"> --}}
