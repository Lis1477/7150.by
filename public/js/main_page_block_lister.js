$(document).ready(function(){
	...
	var bl_width = $('.main-page_popular-items').outerWidth() + item_margin;
	// количество видимых товаров
	var item_count_visible = Math.trunc(bl_width / (item_bl_width - item_margin));
	...
	// количество итераций
	var screen_count_popular;
	if((popular_item_count / item_count_visible).toString().split(".")[1]) {
		screen_count_popular = +(popular_item_count / item_count_visible).toString().split(".")[0] + 1;
	} else {
		screen_count_popular = popular_item_count / item_count_visible;
	}
...
console.log('тянем вправо!');
	...
	var news_item_count_visible = (bl_width + item_margin - 10) / item_bl_width; // количество товаров видимых
...
console.log('тянем вправо!');
	...
	var seen_item_count_visible = (bl_width + item_margin - 10) / item_bl_width; // количество товаров видимых
